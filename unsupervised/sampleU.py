...
def return_model_U1(shape=(436,1024,3)):
    ...
    z1 = Conv2D(12,(5,5), padding='same',activation=act)(I)
    z2 = MaxPooling2D((2,2))(z1)
    z3 = Conv2D(24,(5,5), padding='same',activation=act)(z2)
    z4 = MaxPooling2D((2,2))(z3)
    z5 = Conv2D(12,(5,5), padding='same',activation=act)(z4)

    z6 = Conv2DTranspose(12,(5,5),strides=(2,2), padding='same')(z5)
    z6_concat = Concatenate(axis=-1)([z6,z3])

    z7 = Conv2D(6,(5,5), padding='same',activation=act)(z6_concat)
    z8 = Conv2DTranspose(6,(5,5),strides=(2,2), padding='same')(z7)
    z8_concat = Concatenate(axis=-1)([z8,z1])

    z9 = Conv2D(2,(5,5), padding='same',activation=keras.layers.LeakyReLU(alpha=0.3))(z8_concat)
    ...
    # model.compile(loss=c_recMse_grad(model),optimizer="Adam")
...
model.save_weights("data/grad_U_full.h5")
